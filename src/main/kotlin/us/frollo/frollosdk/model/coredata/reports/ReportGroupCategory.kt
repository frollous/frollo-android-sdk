...
/** Data representation of transactions by category report group */
data class ReportGroupCategory(

    /** Unique ID of the related category */
    val categoryId: Long,
    ...
    /** Indicates if the [ReportGroupCategory.value] is income or expense */
