...
data class IdentityDocument(
    ...
    @SerializedName("id_expiry") var idExpiry: String?, // yyyy-MM-dd
    ...
    @SerializedName("id_sub_type") var idSubType: String?,
    ...
    @SerializedName("extra_data") var extraData: List<IdentityExtraData>?,

    /** The issued date of the document (if known) in yyyy-MM-dd format */
    @SerializedName("id_issued") var idIssued: String?
) {
    companion object {
