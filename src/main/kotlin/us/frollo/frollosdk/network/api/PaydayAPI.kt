...
internal interface PaydayAPI {
    companion object {
        const val URL_PAYDAY = "pay_day"
    }

    @GET(URL_PAYDAY)
    fun fetchPayday(): Call<PaydayResponse>

    @PUT(URL_PAYDAY)
    fun updatePayday(@Body request: PaydayUpdateRequest): Call<PaydayResponse>
}
