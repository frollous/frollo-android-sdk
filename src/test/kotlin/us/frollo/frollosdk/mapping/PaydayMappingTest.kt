...
class PaydayMappingTest {

    @Test
    fun testPaydayResponseToPayday() {
        val response = testPaydayResponseData(status = PaydayStatus.CONFIRMED, frequency = PaydayFrequency.MONTHLY)
